...
gfh-Tr_s
```
Задача состоит в том, чтобы найти непересекающиеся пути. Далее по этим путям пустить муравьев. В промежуточных комнатах не может находиться более одного муравья. В начальной и конечной комнатах может быть любое кол-во муравьев. Шагом считается переход муравьев из одной комнаты в другую. При параллельных путях, за один шаг муравьи идут независимо друг от друга. Задача состоит в том, чтобы кол-во шагов было минимально. Решение оформляется в цепочку, состоящую из комнат, которые посещает каждый из муравьев. Координаты комнат используются при выполнении визуализации, что составляет бонусную часть проекта.
